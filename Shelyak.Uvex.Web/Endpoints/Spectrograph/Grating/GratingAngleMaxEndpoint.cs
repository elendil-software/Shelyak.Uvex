...
public class GratingAngleMaxEndpoint : SpectrographEndpoint<float>
{
    private readonly IUsisDevice _usisDevice;

    public GratingAngleMaxEndpoint(IUsisDevice usisDevice, IServerTransactionIdProvider serverTransactionIdProvider, ILogger<GratingAngleMaxEndpoint> logger)
    ...
    {
        Get(DeviceNumberRoutePattern + ApiRoutes.GratingAngleMax);
        base.Configure();
    }
